...
def upgrade() -> None:
    ...
    op.create_table(
        ...
        sa.Column(
            "role",
            sa.Enum("admin", "customer", "pharmacist", name="user_roles"),
            nullable=False,
        ),
    ...
    op.create_index(
        op.f("ix_inventory_batches_batch_number"),
        "inventory_batches",
        ["batch_number"],
        unique=True,
    )
    op.create_index(
        op.f("ix_inventory_batches_expiry_date"),
        "inventory_batches",
        ["expiry_date"],
        unique=False,
    )
    ...
    op.create_table(
        ...
        sa.Column(
            "status",
            sa.Enum("pending", "approved", "rejected", name="prescriptionstatus"),
            nullable=False,
        ),
        sa.Column(
            "created_at",
    ...
    op.create_index(
        op.f("ix_prescriptions_order_id"), "prescriptions", ["order_id"], unique=True
    )
    op.create_index(
        op.f("ix_prescriptions_user_id"), "prescriptions", ["user_id"], unique=False
    )
...
def downgrade() -> None:
    ...
    op.drop_index(
        op.f("ix_inventory_batches_expiry_date"), table_name="inventory_batches"
    )
    op.drop_index(
        op.f("ix_inventory_batches_batch_number"), table_name="inventory_batches"
    )
