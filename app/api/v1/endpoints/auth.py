...
from app.schemas.user import LoginRequest, RefreshTokenRequest, RegisterCustomerRequest
...
async def signup(
    ...
    return await service.register_customer(
...
async def login(
    ...
    """
    data = await service.login(email=login_data.email, password=login_data.password)
    return data
