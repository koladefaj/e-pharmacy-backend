...
@pytest.mark.parametrize("method, endpoint, payload", [
    ...
    ("post", "/api/v1/pharmacist/register", {
        "email": "new@pharma.com", "full_name": "Pharma", "password": "pass", 
        "phone_number": "+123", "date_of_birth": "1990-01-01", 
        "address": "addr", "license_number": "LN1"
    }),
    ("get", "/api/v1/pharmacist/all", None),
    ("patch", "/api/v1/pharmacist/{id}/approve", {"license_verified": True}),
    ("post", "/api/v1/product/create", {
        "name": "Drug", "slug": "drug", "category": "otc", 
        "active_ingredients": "X", "prescription_required": False
    }),
